...
'@
Add-Type -TypeDefinition $src -Language CSharp -ReferencedAssemblies "System.Net.WebSockets.Client","System.Net.WebSockets"
...
$task = [Cdp]::Run("https://fanqienovel.com/reader/7445246192578986520", $expr, 18000)
$initial = $task.GetAwaiter().GetResult()
